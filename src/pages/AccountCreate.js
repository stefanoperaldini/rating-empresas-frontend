...
import { setErrorMessageCallBackEnd, validatorEmail, validatorPassword, validatorLinkedin, validatorUserName } from './pagesUtils';
      ...
      <main className="centered-container">
        ...
        <form onSubmit={handleSubmit(handleAccountCreate)} noValidate>
          ...
          >
            ...
            <input ref={register(validatorUserName)} name="name" id="name" type="text"
          ...
          >
            ...
            <input
              ref={register(validatorPassword)} name="password" type="password" id="password"
          ...
          >
            ...
            <input
              ref={register(validatorPassword)} name="confirmPassword" type="password" id="confirmPassword"
              placeholder={t("Please enter your password")}>
            </input>
