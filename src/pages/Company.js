...
function getColor(numPositions) {
  ...
  for (let index = 0; index < numPositions; index++) {
    backgroundColorRes = [...backgroundColorRes, backgroundColor[index % 10]];
  }
...
export function Company() {
  ...
  useEffect(() => {
    getCompany(idCompany)
      ...
      .catch(error => {
        setCompany({});
        //if error or not reviews for the company
        history.push("/home");
        return;
      });
          ...
          <section className="flexRow">
            ...
            <section className="companyDetail">
              <header className="companyTitle flexRow m-t-lg b-bog">
                ...
                />
                <h1 className="f-s-xl m-l-xl m-b-xs">{company.name}</h1>
              </header>
              <aside className="asideCompany">
                ...
                <div className={`${classes.rating}`}>
                  ...
                  <Rating
                    ...
                    className="m-l-sm"
                  />
                  <span className="m-l-md f-c-fourgray">{t("Work environment")}</span>
                </div>
                <div className={`${classes.rating}`}>
                  ...
                  <Rating
                    ...
                    className="m-l-sm"
                  />
                  <span className="m-l-md f-c-fourgray">{t("Work&Life balance")}</span>
                </div>
                <section>
