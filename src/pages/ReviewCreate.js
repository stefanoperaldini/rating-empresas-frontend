    ...
    for (let companyItem of companies) {
      if (company.name === companyItem.name) {
        setCompany({
          ...
          sectorName: companyItem.sector,
          sectorId: companyItem.sectorId
        });
        break;
      }
    }
